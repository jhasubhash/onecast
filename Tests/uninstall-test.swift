...
struct UninstallTests {
    ...
    static let ownBundleID = "com.onecast.app"
    static let ownBundleURL = URL(fileURLWithPath: "/Applications/Onecast.app")
    ...
    static func testIdentityRefusal() {
        let byID = UninstallTarget(
            ...
            bundleID: "com.onecast.app", displayName: "Onecast", bundleName: nil)
        expect(
            UninstallIdentity.make(
                target: byID, otherAppNames: [], ownBundleID: ownBundleID,
                ownBundleURL: ownBundleURL) == nil,
            "Onecast refuses to plan its own uninstall by bundle ID")

        let dev = UninstallTarget(
            bundleURL: URL(fileURLWithPath: "/Applications/Onecast Dev.app"),
            bundleID: "com.onecast.app.dev", displayName: "Onecast Dev", bundleName: nil)
        expect(
            UninstallIdentity.make(
                target: dev, otherAppNames: [], ownBundleID: "com.onecast.app.dev",
                ownBundleURL: URL(fileURLWithPath: "/Applications/Onecast Dev.app")) == nil,
