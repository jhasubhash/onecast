...
struct QuicklinkTests {
    ...
    static let home = "/Users/onecast-harness"
    ...
    static func pathDetection() {
        ...
        expect(
            detect("  ~/Projects/Onecast  ") == .path("\(home)/Projects/Onecast"),
    ...
    static func scratchDirectory() -> URL {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("onecast-quicklink-test-\(UUID().uuidString)", isDirectory: true)
