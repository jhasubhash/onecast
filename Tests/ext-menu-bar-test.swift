...
extension ExtensionTests {
    ...
    static func menuBarRenderingChecks() async {
        let controller = ExtensionMenuBarController(
            entryID: "onecast-fixture-rendering", assetsPath: "/tmp", isVisible: false)
    ...
    static func menuBarPendingActionChecks() {
        let controller = ExtensionMenuBarController(
            entryID: "onecast-fixture-pending-action", assetsPath: "/tmp",
            isVisible: false)
        defer { controller.remove() }
    ...
    static func menuBarImageChecks() async {
        ...
        let controller = ExtensionMenuBarController(
            entryID: "onecast-fixture-slow-image", assetsPath: "/tmp",
            isVisible: false,
            loadImage: { _, _, _ in
        ...
        let retry = ExtensionMenuBarController(
            entryID: "onecast-fixture-retry-image", assetsPath: "/tmp",
            isVisible: false,
