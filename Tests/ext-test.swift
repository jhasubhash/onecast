...
struct ExtensionTests {
    ...
    static func runtimeURL() -> URL {
        let candidates = [
            URL(fileURLWithPath: FileManager.default.currentDirectoryPath)
                .appendingPathComponent("Onecast/Resources/RaycastRuntime.generated.js"),
    ...
    static func manifestChecks() {
        ...
        // A manifest with no commands isn't an extension Onecast can run.
    ...
    static func oauthUnitChecks() {
        ...
        let strayURL = URL(string: "onecast://oauth?code=abc&state=xyz")!
        check(
    ...
    static func deepLinkChecks() {
        ...
        let tiny = ExtensionDeepLink.parse(
            url: URL(string: "onecast://extensions/linear/linear/create-issue")!)
        check("deeplink mirrors raycast:// as onecast://", tiny == canonical)
    ...
    static func runtimeChecks() async {
        ...
        let command = """
            ...
            module.exports.default = function Command() {
              ...
              const filePaths = [
                fileURLToPath("file:///Applications/Onecast%20Beta.app"),
              ...
              const encrypted = Buffer.concat([encrypter.update("hello onecast"), encrypter.final()]);
        ...
        check(
            ...
            ExtensionAccessoriesView_labelForTest(
                ...
                + "2c7b4ad2b1515995062e4c0180cec664,"
                + "hello onecast,17d614f379a9359077e95577fd31c20a,ERR_OSSL_BAD_DECRYPT,"
    ...
    static func nodeContractChecks() async {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("onecast-archive-\(UUID().uuidString)")
    ...
    static func swiftHelperChecks() async {
        let helper = FileManager.default.temporaryDirectory
            .appendingPathComponent("onecast-helper-\(UUID().uuidString)")
    ...
    static func processKillChecks() async {
        let marker = FileManager.default.temporaryDirectory
            .appendingPathComponent("onecast-rang-\(UUID().uuidString)")
        ...
        check(
            "exec returns a live pid and process.kill guards Onecast itself",
    ...
    static func zlibChecks() {
        let payload = Data(String(repeating: "onecast extensions ", count: 64).utf8)
        do {
