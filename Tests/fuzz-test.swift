...
struct FuzzTest {
    ...
    static func scorer() {
        ...
        let pinned: [(String, String, Int)] = [
            ...
            ("settings", "System Settings", 17), ("settings", "Onecast Settings", 17),
    ...
    static func comparator() {
        ...
        check(
            "an app wins the tie a Onecast command ties it on",
            first(
                "settings",
                [Item(name: "Onecast Settings", priority: 3), Item(name: "System Settings", priority: 4)])
                == "System Settings")
        check(
    ...
    static let index: [Item] =
        apps + [
            ...
            Item(name: "Onecast Settings"), Item(name: "Calculator History"),
    ...
    static func denseIndex() {
        ...
        let cases: [(query: String, first: String, why: String)] = [
            ("settings", "System Settings", "Apple's alternate name beats Onecast Settings"),
    ...
    static func properties() {
        ...
        let names = [
            ...
            "Search Emoji & Symbols", "Onecast Settings", "Activity Monitor", "Wi-Fi", "Date & Time",
