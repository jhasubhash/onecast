...
const ANCHORS = "Onecast/Features/Settings/SettingsAnchor.swift";
const CATALOG = "Onecast/Features/Settings/SettingsSearchCatalog.swift";
...
const source = swiftSources(path.join(ROOT, "Onecast"))
