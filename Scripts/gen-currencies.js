#!/usr/bin/env node
// Generate Onecast/Features/Calculator/Model/CurrencyData.generated.swift.
//
...
async function main() {
  ...
  const out = path.resolve(__dirname, "..", "Onecast/Features/Calculator/Model/CurrencyData.generated.swift");
