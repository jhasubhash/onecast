// Bundles the embedded extension runtime into Onecast/Resources/RaycastRuntime.generated.js.
//
//   pnpm install && node gen-enums.mjs && node build.mjs
//
// The output is committed (like EmojiData.generated.swift) so building Onecast never needs Node.

import { build } from "esbuild";
import { mkdirSync, statSync, writeFileSync } from "node:fs";
import { dirname, resolve } from "node:path";

const outFile = resolve("../../Onecast/Resources/RaycastRuntime.generated.js");
...
// `__onecastCompile` has to compile in the *global* scope so the extension bundle it evaluates can't
