# Contributing to Onecast

Check existing [issues](https://github.com/jhasubhash/onecast/issues) and
[pull requests](https://github.com/jhasubhash/onecast/pulls) first.
...
- **No bloat.** Onecast stays small on purpose — quality over quantity. A clean patch still gets
...
- `open Onecast.xcodeproj` → ⌘R. Debug builds are their own channel (`Onecast Dev.app`).
...
macOS version, Onecast version + channel, steps, expected vs actual. A recording beats a paragraph.
