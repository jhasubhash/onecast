...
Include your macOS version, the Onecast version and channel, reproduction steps, and the impact.
...
Current stable and beta only. Update (`brew upgrade --cask onecast`) before reporting.
...
- **Network** — Onecast is offline by default and every networked feature is consent-gated. A path
