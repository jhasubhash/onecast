...
Dragging an app to the Trash leaves its support files scattered around your Library. Onecast's
...
Onecast **checks** for Full Disk Access and **never asks** for it. See
