---
title: App launcher
description: One search across everything Onecast knows about, and how it decides what comes first.
---
...
Onecast looks at several names for each entry, and trusts some more than others:
...
Onecast learns which result you pick for a search, on your Mac, and moves it up next time.
...
What it learns stays in `launcher-ranking.json` in Onecast's own folder and goes nowhere else.
...
Onecast looks **one folder deep**, so `/Applications/Blackmagic Design/DaVinci Resolve.app` is found
...
[system action](/docs/launcher/system-actions). It leaves Finder and Onecast running.
