...
Onecast works out what a link is from how it looks:
...
Quicklinks live in `quicklinks.sqlite3` in Onecast's Application Support folder. If that file ever
cannot be opened, Onecast **reports it and never deletes it**. Your links are something you made, not
