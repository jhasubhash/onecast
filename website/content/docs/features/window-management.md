...
Restore Window also works on windows Onecast has never moved, because it notes the frame before the first
...
app refuses to shrink, Onecast lines the window up against its side **once**, never in a loop.
