...
export const site = {
  ...
  repo: "https://github.com/jhasubhash/onecast",
  url: "https://onesyntax.in/onecast",
  // Shown only until the build-time release lookup resolves, and if it fails.
  fallbackVersion: "v0.9.7",
  platform: "macOS 26+",
  license: "AGPL-3.0",
  licenseUrl: "https://github.com/jhasubhash/onecast/blob/main/LICENSE",
  community: {
    discord: "https://discord.gg/v2Eeb4QQy3",
  },
  support:
    "https://www.buymeacoffee.com/subhashjha",
} as const;
...
export const brewTrustCommand = "brew trust --tap jhasubhash/onecast";
