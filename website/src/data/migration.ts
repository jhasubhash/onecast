...
export const migration = {
  ...
  intro:
    "Onecast reads a Raycast export directly. Point it at your .rayconfig file, type the passphrase, and your shortcuts come with you.",
  ...
  requirement: {
    ...
    body: "Onecast reads the .rayconfig that Raycast v2.0 and later write. Raycast v1.x files are not supported — that format was dropped in Onecast v0.10.5.",
  },
  steps: [
    {
