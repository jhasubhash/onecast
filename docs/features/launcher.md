...
| --- | --- | --- |
| `.userAlias` | the alias the user typed in Onecast, for any entry kind | literal |
...
> **Invariant:** `Tests/fuzz-test.swift` compiles the real `Onecast/Features/Launcher/Model/SearchRelevance.swift`, so
