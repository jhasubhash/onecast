...
activation policy, since opening About flips Onecast itself to `.regular`.
...
front**. Capturing from Settings marks nothing, because Onecast itself is frontmost then.
