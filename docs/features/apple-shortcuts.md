...
searchable by name and runnable with ↵, a favorite slot or a global shortcut. Onecast lists and runs
...
Onecast wasn't running is caught too — sweeps. `AppleShortcut.staleIDs` collects every
