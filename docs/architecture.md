...
How Onecast is wired together. Per-feature internals live in [features/](README.md#features);
...
`OnecastApp` (`@main`) declares only two `MenuBarExtra` scenes — Onecast's own item and the
