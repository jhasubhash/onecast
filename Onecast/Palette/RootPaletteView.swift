...
struct RootPaletteView: View {
    ...
    private var appMenuContent: PopoverMenuContent {
        PopoverMenuContent(items: [
            PopoverMenuItem(title: "About Onecast", systemImage: "info.circle") {
                core.settingsCoordinator.showAbout()
            },
            PopoverMenuItem(title: "Support Onecast", systemImage: "heart") {
    ...
    private var header: some View {
        HStack(alignment: headerVerticalAlignment, spacing: 0) {
            ...
            if vm.mode == .ai {
                // The field runs to here, so a wider gutter keeps a full line off the model name.
