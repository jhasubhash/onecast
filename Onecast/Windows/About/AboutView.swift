...
private struct AboutLink: Identifiable {
    ...
    static let all: [AboutLink] = [
        AboutLink(
            ...
            detail: "onesyntax.in/onecast",
            url: URL(string: "https://onesyntax.in/onecast/")!),
        AboutLink(
            id: "github", glyph: .brand("BrandGitHub"), title: "GitHub",
            detail: "github.com/jhasubhash/onecast",
            url: URL(string: "https://github.com/jhasubhash/onecast")!),
        AboutLink(
