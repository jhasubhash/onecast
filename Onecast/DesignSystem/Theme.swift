...
enum Theme {
    ...
    enum Size {
        ...
        /// Onecast's own dialog: fixed width, height measured from the SwiftUI content.
    ...
    /// Motion owned by Onecast's menus; extension-provided panels keep their own behavior.
    @MainActor
    enum MenuMotion {
