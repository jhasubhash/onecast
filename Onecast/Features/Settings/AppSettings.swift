...
final class AppSettings {
    ...
    /// Follow macOS, or pin Onecast to one appearance. Applied by `AppCore.applyAppearance()`.
    ...
    /// Off out of the box: on means Onecast may read a selection anywhere and type over it.
    ...
    /// For a toolchain Onecast doesn't know — mise or Nix shims are the common case.
