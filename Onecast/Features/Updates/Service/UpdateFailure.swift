...
enum UpdateFailure: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .noAppInArchive:
            return "The downloaded archive does not contain Onecast."
        case .quarantined:
            return "macOS quarantined the downloaded app and Onecast could not clear the flag."
        case .bundleMismatch:
            return "The downloaded app is not this build of Onecast."
        case .identityMismatch:
        ...
        case .replaceFailed(let detail):
            return "Onecast could not be replaced. \(detail)"
        }
    }
