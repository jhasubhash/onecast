...
final class CodexTurnRunner {
    private static let safetyInstructions = """
        You are providing text generation inside Onecast. Never invoke tools, execute commands, read \
    ...
    private static let toolInstructions = """
        You are providing text generation inside Onecast. You may call the MCP tools provided to \
