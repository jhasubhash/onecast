...
/// Seals a `BackupBundle` directory into one `.onecast` file, and opens one back up.
enum BackupArchive {
    static let fileExtension = "onecast"
    ...
    enum ArchiveError: LocalizedError, Equatable {
        ...
        var errorDescription: String? {
            ...
            case .cannotRead: return "This file isn't a Onecast backup, or it's damaged."
            }
        }
    }
