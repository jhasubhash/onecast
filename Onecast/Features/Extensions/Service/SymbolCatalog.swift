...
struct SymbolCategory: Identifiable, Hashable, Sendable {
    ...
    static let suggested = SymbolCategory(id: "onecast.suggested", title: "Suggested")
    static let all = SymbolCategory(id: "onecast.all", title: "All Symbols")
    static let bundled = SymbolCategory(id: "onecast.bundled", title: "Onecast")
}
