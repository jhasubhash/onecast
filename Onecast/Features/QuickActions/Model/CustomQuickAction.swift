...
enum CustomQuickActionError: Error, LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .invalidCharacter: return "The name contains a character Onecast can't store."
        case .storageUnavailable: return "Onecast couldn't save to its actions file."
        }
    }
}
