...
enum CommandID: String, CaseIterable, Sendable {
    ...
    case createScheduledTask = "command:create-scheduled-task"
    ...
    var name: String {
        ...
        case .createScheduledTask: return "Create Scheduled Task"
        ...
        case .settings: return "Onecast Settings"
        case .about: return "About Onecast"
        case .support: return "Support Onecast"
        case .quit: return "Quit Onecast"
        }
    }
    ...
    var sfSymbol: String {
        ...
        case .createScheduledTask: return "calendar.badge.plus"
